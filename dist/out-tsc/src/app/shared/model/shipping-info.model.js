var ShippingInfoModel = /** @class */ (function () {
    function ShippingInfoModel(id, name, street, phone, specialInstructions, zipCode, products, isPayed, isShipped, user, createdAt, startDate, endDate, payed, productCount) {
        this._name = name;
        this._street = street;
        this._phone = phone;
